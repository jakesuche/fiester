...
export const section1Content = {
  ...
  HorseImage,
  ShootingStarImage,
  title: "Discover the Best Events in Lagos",
  subtitle: "Discover new experiences and make lasting memories",
};
...
export const section3Content = {
  title: "Explore the best events across multiple cities and discover new experiences to enhance your life.",
  ITEMS: [
  
    { logo: EthImg, name: "Keynote Speakers" },
    { logo: BscImg, name: "Interactive Workshops" },
    { logo: PolygonImg, name: "Networking Sessions" },
    { logo: OptimismImg, name: "Panel Discussions" },
    { logo: GnosisImg, name: "Exhibition Booths" },
    { logo: AvalancheImg, name: "Hackathons" },
    { logo: ArbitrumImg, name: "Product Demos" },
    { logo: FantomImg, name: "Live Performances" },
    { logo: KlaytnImg, name: "Q&A Sessions" },
    { logo: AuroraImg, name: "Virtual Tours" },
  ],
};
...
export const section4Content = {
  top: {
    ...
    subtitle:
      "Experience the Ultimate Convenience in Event Ticketing with Our One-Stop Solution - Get Your Tickets with Just One Click!",
    image: NewsImg,
  },
  bottom: {
    title: "Fiester flow",
...
export const section6Content = {
  title: "Fiester Tools",
  subtitle:"Simple Tools for a Successful Event",
  ITEMS: [
    {
      title: "Ticketing",
      subtitle:
...
export const footerContent = {
  ...
  subscribe: {
    title: "Subscribe to fiester newsletter",
  ...
  copyright: {
    left: "© 2023 fiester, All Rights Reserved.",
    center: "",
    right: "",
  },
};
